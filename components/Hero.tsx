...
const heroContent: Record<Mode, {
 ...
 enhance: {
 badge: "Free Image & Video Enhancer",
 badgeIcon: "wand",
 title: (
 <>
 ...
 description:
 "Upscale, sharpen, and enhance your photos and videos. Improve brightness, contrast, and detail instantly.",
 },
};
...
export default function Hero({ children, mode = "watermark" }: { children: React.ReactNode; mode?: Mode }) {
 ...
 <p className="text-base md:text-lg text-gray-600 mb-8 max-w-2xl mx-auto animate-fade-in" style={{ animationDelay: "0.15s" }}>
 {content.description}
 </p>
 </div>
 {children}
