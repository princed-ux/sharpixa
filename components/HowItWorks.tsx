...
const steps = [
  ...
  { num: "3", icon: "wand", title: "AI Processing", desc: "Your file is processed instantly in your browser — nothing is uploaded." },
  ...
  return (
    <section className="section" id="how-it-works">
      <div className="container-x">
        ...
        <p className="text-center text-gray-500 dark:text-gray-400 mb-10">Remove watermarks in 4 simple steps</p>
